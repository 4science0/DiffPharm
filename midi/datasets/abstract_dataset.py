...
class AbstractDatasetInfos: 
    def complete_infos(self, statistics, atom_encoder, phar_encoder=None):
        self.atom_decoder = [key for key in atom_encoder.keys()]
        self.num_atom_types = len(self.atom_decoder)
        
        if phar_encoder is not None:
            self.phar_decoder = [key for key in phar_encoder.keys()]
            self.num_phar_types = len(self.phar_decoder)
        ...
        self.phar_types = statistics['train'].phar_types
